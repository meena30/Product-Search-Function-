...
$i =1;
 ...
 $page_for_posts = get_option( 'page_for_posts' );
  ...
  $banner_image = wp_get_attachment_image_src( get_post_thumbnail_id($page_for_posts), 'single-post-thumbnail' );
...
$topic_detail = get_terms(
  ...
  $business_list = ["education", "Investments"];
...
$selected_filter_val .='<div class="event-topfilter m-b-60 p-t-10">
  <div class="event-topfilter-value">
    <div class="row">
      <div class="col-sm-12">
...
<div class="searchtool-banner insights-banner" style="background-image: url(<?php echo $banner_image[0]; ?>) !important;">
          ...
          <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-12">
                  ...
                  <div class="row justify-content-between">
                    <div class="col-sm-4 pr-4">
                      <div class="seach-textbox">
                        <input type="text" name="s" placeholder="What you're looking for?" type="text" class="form-control" value="<?php echo $_REQUEST['s']; ?>" />
                    ...
                    <div class="col-sm-6">
                      <div class="row event-topfilter m-t-20 mb-0">
                        <div class="col">
                ...
                <div class="col-sm-12 eventers-section inlights-morelist p-0">
                ...
                <!--<input type="hidden" name="max_pagenum" value="<?php echo $max_pagenum; ?>">-->

                <div class="text-center w-100 m-t-40 m-b-60 loadmore">
                  <?php echo $loadbtn; ?>
                  <!--<a href="" class="eventbtn text-uppercase text-decoration-none d-block mx-auto">load more insights<span><img src="<?php echo get_template_directory_uri(); ?>/images/down-white.png" alt="" ></span></a>-->
                </div>
